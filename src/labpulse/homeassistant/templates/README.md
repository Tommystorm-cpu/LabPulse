...
| `alarm/scripts.yaml.j2` | Bulk editing and SMS request scripts |
...
continuous safe recovery beyond deadband to return to Normal. Sensor and
service faults are separate. Power has an outage/restoration lifecycle. Mutes
suppress delivery, not state calculation; Test mode selects test recipients.
