...
from ..measurement_catalog import MeasurementCatalog, MeasurementKey
...
class DashboardIndex:
    ...
    def from_model(
        ...
        measurements = {
            item.key: render_measurements[
                (item.key.service_name, slug(item.key.measurement_name))
            ]
