...
def load_sms_templates() -> dict[str, Any]:
    ...
    required_paths = (
        ("alerts", "service_offline", "title"),
        ("alerts", "service_offline", "message"),
        ...
        ("alerts", "reading_unavailable", "title"),
        ("alerts", "reading_unavailable", "message"),
        ("alerts", "reading_available", "title"),
        ("alerts", "reading_available", "message"),
