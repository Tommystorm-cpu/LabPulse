...
TEST_CASES = [
    {
        "name": "standard pressure pipe is already in configured units",
    ...
    {
        "name": "standard pump pipe parses every valid channel and skips null",
        "service_name": "pump_room",
        "parser_type": "pipe",
        "line": "flow1: 0.27 | flow2: 0.00 | temp0: 25.10 | temp1: null | roomtemp: 21.2 | roomhum: 45.0 | press1: 1.23 | press2: 1.45",
        "expected": {
            "flow1": 0.27,
            "flow2": 0.0,
            "temp0": 25.1,
    ...
    {
        "name": "standard turbo pipe uses the generic parser",
        "service_name": "turbo_pump",
        "parser_type": "pipe",
        "line": "flow1: 2.45 | flow2: 3.10 | temp0: 20.11 | temp1: 20.22",
