    ...
    for service in model.services:
        ...
        if service.power is not None:
            ...
            service_map["power_lifecycle"] = {
                "source": power.source,
                "raw_mains_present": power.mains_present.expected_entity_id,
                "mains_present": power.mains_present_entity,
                ...
                "outage_active": power.outage_active_entity,
                "outage_confirm_seconds": power.outage_confirm_seconds,
                "restore_confirm_seconds": power.restore_confirm_seconds,
