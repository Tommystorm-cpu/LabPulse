...
This directory documents the active implementation at the repository root.
...
| Which Python file produces each Home Assistant resource? | [`src/labpulse/homeassistant/README.md`](../src/labpulse/homeassistant/README.md#generation-flow) |
...
| Generated alarm behavior | `src/labpulse/homeassistant/templates/alarm/alarm_logic.yaml` |
| Generated UPS power lifecycle | `src/labpulse/homeassistant/templates/alarm/power_logic.yaml` |
