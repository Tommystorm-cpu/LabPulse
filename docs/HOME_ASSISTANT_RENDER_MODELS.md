...
The catalogue models live in `src/labpulse/homeassistant/measurement_catalog.py`.
...
These models live in `src/labpulse/homeassistant/measurement_model.py`.
...
These models live in `src/labpulse/homeassistant/render_model.py`.
